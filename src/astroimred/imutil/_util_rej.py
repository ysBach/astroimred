...
from ._util_rej_nb import ccdclip_std_numba, reject_minmax_numba, reject_sigclip_numba
...
def sigclip_mask(
    ...
    # Original path (fallback when IMOPS_USE_NUMBA is False or arr not 3D):
    ...
    #     irafmode=irafmode,
    # )
    if config.IMOPS_USE_NUMBA and arr.ndim == 3:
